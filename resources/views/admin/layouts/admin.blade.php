...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li class="{{ request()->is('admin/bill_details*') ? 'active' : '' }}">
                <a href="{{ route('admin.bill_details.index') }}"><i class="fas fa-file-invoice-dollar"></i> Bill
                    Details-Cashback</a>
            </li>
            
             <li class="{{ request()->is('admin/bill_reward*') ? 'active' : '' }}">
                <a href="{{ route('admin.bill_reward.index') }}"><i class="fas fa-file-invoice-dollar"></i> Bill
                    Details-Reward</a>
            </li>
