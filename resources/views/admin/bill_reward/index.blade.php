...
@section('content')
    ...
    <tbody>
        <tr>
            ...
            <td>₹2,500</td>
            <td>
                <input type="number" class="cashback-input" placeholder="₹ Reward">
                <div class="cashback-buttons">
                    <button class="btn-approve">Approve</button>
                    <button class="btn-discard">Discard</button>
                </div>
            </td>
            <td> <a href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf" 
                   target="_blank" class="btn-delete">View Bill</a></td>
            <td>
                <a href="{{ route('admin.bill_reward.view') }}" class="btn-view">View</a>
